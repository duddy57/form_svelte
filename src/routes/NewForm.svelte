...
<div>
    <form method="POST" action="/create" class="space-y-8 py-8 w-full" use:enhance>
        <Form.Field {form} name="form_date" class="flex flex-col">
            <Form.Control>
              {#snippet children({ props })}
                ...
                <Form.Description
                  >Data de abertura do atendimento</Form.Description
                >
                <Form.FieldErrors />
        ...
        <Form.Field {form} name="tecnico_forms" class="flex flex-col">
            ...
            <Form.Description>
              Tecnico responsavel pelo atendimento.
            </Form.Description>
            <Form.FieldErrors />
        </Form.Field>
                    ...
                    {#each formdate.tec_email as tec}
                      ...
                      >
                        ...
                        <Check
                          class={cn(
                            "ml-auto",
                            tec.value !== $formData.tecnico_os && "text-transparent"
                          )}
                        />
                      </Command.Item>
                    {/each}
        ...
        <Form.Field {form} name="cliente" class="flex flex-col">
            <Popover.Root>
              ...
              <Popover.Content class="w-[400px] h-[300px] p-0">
                <Command.Root>
                  <Command.Input
                    autofocus
                    placeholder="Encontra cliente..."
                    class="h-9"
                  />
                    ...
                    {#each formdate.cliente as clt}
                      ...
                      >
                        ...
                        <Check
                          class={cn(
                            "ml-auto",
                            clt.value !== $formData.cliente && "text-transparent"
                          )}
                        />
                      </Command.Item>
                    {/each}
            ...
            <Form.Description>
              Cliente a qual o atendimento foi direcionado.
            </Form.Description>
            <Form.FieldErrors />
        </Form.Field>
        ...
        <Form.Field {form} name="necessario_tecnico"
        ...
        <Form.Control>
          {#snippet children({ props })}
            <div class="space-y-0.5">
              ...
              <Form.Description>
                Foi necessario enviar um tecnico ao local
              </Form.Description>
            </div>
        ...
        <Form.Field {form} name="defeito" class="flex flex-col">
            <Popover.Root>
              ...
              <Popover.Content class="w-[400px] h-[300px] p-0">
                <Command.Root>
                  <Command.Input
                    autofocus
                    placeholder="Encontre o defeito..."
                    class="h-9"
                  />
            ...
            <Form.Description>
               Defeito encontrado no atendimento.
            </Form.Description>
            <Form.FieldErrors />
        </Form.Field>
        <Form.Field {form} name="solucao" class="flex flex-col">
            <Popover.Root>
              ...
              <Popover.Content class="w-[400px] h-[300px] p-0">
                <Command.Root>
                  <Command.Input
                    autofocus
                    placeholder="Encontre a solução..."
                    class="h-9"
                  />
            ...
            <Form.Description>
               Solução encontrada para resolver o atendimento.
            </Form.Description>
            <Form.FieldErrors />
        </Form.Field>
